...
const partners: Partner[] = [
  { name: "Partner 1", logo: "./logo_lpi.jpg" },
  { name: "Partner 2", logo: "./logo_lpi.jpg" },
  { name: "Partner 3", logo: "./logo_lpi.jpg" },
  { name: "Partner 4", logo: "./logo_lpi.jpg" },
  { name: "Partner 5", logo: "./logo_lpi.jpg" },
  { name: "Partner 6", logo: "./logo_lpi.jpg" },
  { name: "Partner 7", logo: "./logo_lpi.jpg" },
  { name: "Partner 8", logo: "./logo_lpi.jpg" },
]
